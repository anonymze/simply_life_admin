...
import { z } from "zod";
import { CheckCircle, Link, X } from "lucide-react";
...
export default function FormPage({
	...
	async function onSubmit(values: z.infer<typeof formSchema>) {
		...
		try {
			...
			const response = await fetch(serverURL + "/api/app-users/finish-registration", {
				method: "POST",
				body: formData,
			});
			...
			{!success ? (
				...
				<Card>
					...
					<CardContent className="text-center">
						<p className="mb-4">
							Vous pouvez maintenant accéder l'application mobile Simply
							Life avec vos identifiants.
						</p>
					</CardContent>
				</Card>
			)}
